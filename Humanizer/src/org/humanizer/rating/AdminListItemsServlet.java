...
public class AdminListItemsServlet extends HttpServlet {
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse resp)
	  ...
	  //1. Get tasks data
	  String sURL = "http://humanizer.iriscouch.com/tasks/_design/api/_view/task_data?startkey=%22" + taskId + "%22&endkey=%22" + taskId + "%22";	  
	  ...
	  sURL = "http://humanizer.iriscouch.com/items/_design/index/_view/items_in_task?startkey=%22" + taskId + "%22&endkey=%22" + taskId + "%22&include_docs=true";	  
